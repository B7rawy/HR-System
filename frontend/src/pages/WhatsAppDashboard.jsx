    ...
    const handleTestMessage = async () => {
        ...
        try {
            ...
            if (testForm.templateName) {
                // إضافة بيانات تجريبية تلقائية لكريم البحراوي
                const autoTemplateData = {
                    employeeName: 'كريم البحراوي',
                    companyName: 'شركة الموارد البشرية المتطورة',
                    ...
                    time: '10:00 صباحاً',
                    status: 'تمت الموافقة',
                    startDate: '25 ديسمبر 2024',
                    endDate: '31 ديسمبر 2024',
                    title: 'إجازة نهاية السنة',
                    content: 'ستكون الشركة مغلقة من 25-31 ديسمبر للإجازة السنوية.',
