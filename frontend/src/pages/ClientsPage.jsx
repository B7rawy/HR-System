...
const ClientsPage = () => {
  ...
  const [clients, setClients] = useState([
    {
      ...
      creditLimit: 50000,
      currentBalance: 15750, // موجب = له علينا، سالب = عليه لنا
    ...
    },
    {
      ...
      email: 'contracts@nile-construction.com',
      phone: '01123456789',
      ...
      notes: 'مشاريع كبيرة - يحتاج متابعة'
    },
    {
      id: 3,
      name: 'محمد علي - تاجر تجزئة',
      ...
      notes: 'تعامل ممتاز - دفع نقدي'
    },
    {
      id: 4,
      name: 'شركة الدلتا للصناعات',
      email: 'sales@delta-industries.com',
      phone: '01567890123',
      ...
      paymentTerms: '60 يوم',
      category: 'صناعة',
      contactPerson: 'فاطمة محمود',
      notes: 'تأخير في السداد - يحتاج مراجعة'
    },
    {
      id: 5,
      name: 'مكتب الإبداع للاستشارات',
      email: 'info@creativity-consulting.com',
      phone: '01098765432',
      ...
      totalTransactions: 8,
      joinDate: '2024-05-12',
      lastTransaction: '2024-06-06',
      paymentTerms: '21 يوم',
      category: 'استشارات',
      contactPerson: 'هشام عبدالله',
  ...
  const clientStats = {
    ...
    suspended: clients.filter(c => c.status === 'معلق').length,
    totalBalance: clients.reduce((sum, c) => sum + c.currentBalance, 0),
    totalCredit: clients.reduce((sum, c) => sum + c.creditLimit, 0),
...
const ClientModal = ({ title, client, onSave, onClose }) => {
  const [formData, setFormData] = useState({
    ...
    paymentTerms: client?.paymentTerms || '30 يوم',
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input
                ...
                placeholder="مثال: تجارة عامة، مقاولات، استشارات"
              />
            </div>
